<?php
include('C:\xampp\htdocs\Gym-website-using-php--main\database\db_connection.php');
session_start();
          ...
          style="font-weight: 700;">Login Into Your Account</h5>
            ...
            <div class="col mb-2 mt-4">
                <p class="text-center" 
                  ...
                  ><a href="./register.php"
                        style="text-decoration: none;">Create Account</a> OR <a href="C:\xampp\htdocs\GymWebsite\register.php">
